...
from meffi_prompt.data import SmilerDataset, SmilerFewShotDataset
...
@hydra.main(config_name="config_fs", config_path="configs")
def main(cfg: DictConfig) -> None:
    ...
    train_dataset = SmilerFewShotDataset(cfg.train_file, cfg.kshot)
